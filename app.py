...
def index():
    if request.method == 'POST':
        if 'resume' not in request.files:
            return render_template('index.html', data=None, error='No file part')
        
        file = request.files['resume']
        if file.filename == '':
            return render_template('index.html', data=None, error='No selected file')
        ...
        try:
            ...
            if data:
                ...
                return render_template('index.html', data=None, error='Failed to process resume')
        except Exception as e:
