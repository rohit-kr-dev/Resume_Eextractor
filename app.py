...
Output	CSV format
🚀 How It Works
Upload multiple resumes (PDF or DOCX files)
The app extracts key fields using NLP and pattern matching
Users can select which fields to display/export using checkboxes
All extracted data is shown in a table
Click "Export" to download a structured CSV of the selected fields
📂 Project Structure
